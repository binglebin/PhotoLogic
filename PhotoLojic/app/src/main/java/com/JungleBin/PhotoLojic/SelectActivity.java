...
public class SelectActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_IMAGE_CROP2 = 5555;


    Button btn_capture, btn_album, btnNext, btnOption;
...
//        btnOption = (Button)findViewById(R.id.btnOption);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("android.resource://"+ getApplicationContext().getPackageName()+"/drawable/heart");
                Intent uriintent = new Intent(getApplicationContext(), GameViewActivity.class);
                uriintent.putExtra("imageUri", uri);
...
/*
        btnOption.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent optintent = new Intent(getApplicationContext(), OptionActivity.class);
...
*/
        ...
        if (Environment.MEDIA_MOUNTED.equals(state)) {
            ...
            if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                ...
                if (photoFile != null) {
                    ...
                    Uri providerURI = FileProvider.getUriForFile(this, "com.example.PhotoLojic", photoFile);
    ...
    public File createImageFile() throws IOException {
        ...
        File imageFile = null;
        File storageDir = new File(Environment.getExternalStorageDirectory() + "/Pictures", "PhotoLogic");
...
//        cropIntent.putExtra("outputY", 200); // crop한 이미지의 y축 크기
        ...
        startActivityForResult(i, REQUEST_IMAGE_CROP2);
    }
    @Override
        ...
        switch (requestCode) {
            case REQUEST_TAKE_PHOTO:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Toast.makeText(SelectActivity.this, "사진찍기를 취소하였습니다.", Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            case REQUEST_IMAGE_CROP:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Intent uriintent = new Intent(this, GameViewActivity.class);
                    uriintent.putExtra("imageUri", albumURI);
                    startActivity(uriintent);
                    finish();
                }
                break;

            case REQUEST_IMAGE_CROP2:
                if (resultCode == Activity.RESULT_OK) {

                    Toast.makeText(this, "잠시만 기다려주세요.", Toast.LENGTH_LONG).show();
                    iv_view.setImageURI(imageUri);
                    Intent uriintent = new Intent(this, GameViewActivity.class);
                    uriintent.putExtra("imageUri", imageUri);
                    startActivity(uriintent);
                    finish();
                }
                break;
        ...
        switch (requestCode) {
            case MY_PERMISSION_CAMERA:
                for (int i = 0; i < grantResults.length; i++) {
                    ...
                    if (grantResults[i] < 0) {
                        Toast.makeText(SelectActivity.this, "해당 권한을 활성화 하셔야 합니다.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                // 허용했다면 이 부분에서..
